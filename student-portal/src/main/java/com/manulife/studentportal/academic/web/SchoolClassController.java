...
import static com.manulife.studentportal.auth.SecurityExpressions.ADMIN_OR_ASSIGNED_TO_CLASS;
...
public class SchoolClassController {
    ...
    public ResponseEntity<ApiResponse<List<StudentInfo>>> getClassStudents(
            @Parameter(description = "Class ID") @PathVariable Long id,
            @Parameter(description = "Pagination parameters (page, size, sort)")
            Pageable pageable) {

        List<StudentInfo> students = schoolClassService.getStudents(id, pageable);
