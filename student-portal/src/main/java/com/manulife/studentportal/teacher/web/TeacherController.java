...
import static com.manulife.studentportal.auth.SecurityExpressions.ADMIN_OR_OWNER_TEACHER;
...
public class TeacherController {
    ...
    public ResponseEntity<ApiResponse<List<SchoolClassInfo>>> getTeacherClasses(
            @Parameter(description = "Teacher ID") @PathVariable Long id) {

        List<SchoolClassInfo> classes = teacherService.getClasses(id);
    ...
    public ResponseEntity<ApiResponse<List<SubjectInfo>>> getTeacherSubjects(
            @Parameter(description = "Teacher ID") @PathVariable Long id) {

        List<SubjectInfo> subjects = teacherService.getSubjects(id);
